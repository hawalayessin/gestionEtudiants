...
$rech=$_POST['rech'];
$sql="select * from etudiant where nom like'%$rech%' or prenom like'%$rech%' or matricule like'%$rech%' or adresse like'%$rech%' or filiere like'%$rech%' or stage like'%$rech%' or email like'%$rech%'";
